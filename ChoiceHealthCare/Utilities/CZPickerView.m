...
- (instancetype)initWithHeaderTitle:(NSString *)headerTitle
    ...
    if(self){
        ...
        self.headerBackgroundColor = [UIColor colorWithRed:0/255.0 green:118.0/255.0 blue:182.0/255.0 alpha:1.0];
        ...
        self.confirmButtonBackgroundColor = [UIColor colorWithRed:40/255.0 green:165.0/255.0 blue:220.0/255.0 alpha:1.0];
